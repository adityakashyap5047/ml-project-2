...
from networksecurity.entity.artificat_entity import (
...
class DataTransformation:
    ...
    def get_data_transformer_object(cls) -> Pipeline:
        """
            It initiate a KNNImputer object with the parameters specified in the 
            training_pipeline.py files and returns a pipeline object with the
