...
class DataValidation:
    ...
    def detect_dataset_drift(self, base_df, current_df, threshold=0.85) -> bool:
        try:
            status = True
            report = {}
            for column in base_df.columns:
                ...
                drift_dir_path = os.path.dirname(drift_report_file_path)
    ...
    def initiate_data_validation(self) -> DataValidationArtifact:
        try:
            ...
            ### Here we validate the data with the help of the validation status 
            # instead of doing some checks or condition on the status 
